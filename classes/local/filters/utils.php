...
class utils {
                        ...
                        if (class_exists($classname)) {
                            ...
                            if (
                                $reflector->isSubclassOf(
                                    \local_activitylibrary\local\filters\base::class
                                )
                            ) {
     ...
     *
     * In general we will take the one out of the local_activitylibrary namespace
    ...
    public static function add_filter_operators_to_form(
        ...
        $opinstructions = '';
        switch ($operator) {
            case activitylibrary_filter_interface::OPERATOR_LESSTHAN:
                $opinstructions = 'lessthan';
                break;
            case activitylibrary_filter_interface::OPERATOR_GREATERTHAN:
                $opinstructions = 'greaterthan';
                break;
            case activitylibrary_filter_interface::OPERATOR_EMPTY:
                $opinstructions = 'empty';
                break;
            case activitylibrary_filter_interface::OPERATOR_NOTEMPTY:
