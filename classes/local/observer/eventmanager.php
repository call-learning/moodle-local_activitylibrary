...
namespace local_activitylibrary\local\observer;
...
class eventmanager {
     ...
     * in the local_activitylibrary table. If so, we need to add a record to the local_activitylibrary table for the
     * new course.
