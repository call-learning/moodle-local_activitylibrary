...
/**
 * Plugin to manage Activity Library
 *
...
$string['card'] = 'Card';
$string['category:general'] = 'Activity Library: Generic fields';
$string['copied'] = 'Copied to clipboard';
$string['course_metadata'] = 'Metatdata for course Activity Library';
$string['enableactivitylibrary'] = 'Enable Activity Library';
$string['filter:anyvalue'] = 'Any';
$string['filter:course'] = 'Course';
$string['filter:modname'] = 'Activity type';
...
$string['list'] = 'List';
$string['mainactivitylibrary'] = 'Main library';
...
$string['pluginname'] = 'Activity Library';
