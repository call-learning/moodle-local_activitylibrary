...
/**
 * Activity Library data generator.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_activitylibrary_generator extends component_generator_base {
    ...
    public function create_category($record = null) {
        ...
        if (!isset($record->component)) {
            $record->component = 'local_activitylibrary';
        }
    ...
    public function create_fielddata($fielddata): \core_customfield\data_controller {
        ...
        if (local_activitylibrary\locallib\utils::is_multiselect_installed()
